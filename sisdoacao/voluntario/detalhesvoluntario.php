...
if (!isset($_GET['id']) || !is_numeric($_GET['id'])) {
    die('ID do voluntário não fornecido ou inválido.');
}
...
if ($voluntario) {
    ...
    echo '<tr><th>Email</th><td>' . ($voluntario['email']) . '</td></tr>';
    echo '<tr><th>Telefone</th><td>' . ($voluntario['telefone']) . '</td></tr>';
    echo '<tr><th>Gênero</th><td>' . ($voluntario['genero']) . '</td></tr>';
    echo '<tr><th>Data de Nascimento</th><td>' . ($voluntario['data_nascimento']) . '</td></tr>';
    ...
    echo '<tr><th>Disponibilidade</th><td>' . ($voluntario['disponibilidade']) . '</td></tr>';
    echo '</table>';
} else {
